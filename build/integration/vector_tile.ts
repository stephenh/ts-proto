...
export const Tile = {
  encode(message: Tile, writer: Writer = new Writer()): Writer {
...
export const Tile_Value = {
  encode(message: Tile_Value, writer: Writer = new Writer()): Writer {
...
export const Tile_Feature = {
  encode(message: Tile_Feature, writer: Writer = new Writer()): Writer {
...
export const Tile_Layer = {
  encode(message: Tile_Layer, writer: Writer = new Writer()): Writer {
