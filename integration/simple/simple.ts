...
function createBaseSimple(): Simple {
      return { name: "",age: 0,createdAt: undefined,child: undefined,state: 0,grandChildren: [],coins: [],snacks: [],oldStates: [],thing: undefined,blobs: [],birthday: undefined,blob: new Uint8Array(0),enabled: false };
    }
...
function createBaseSimpleWithMap(): SimpleWithMap {
      return { entitiesById: {},nameLookup: {},intLookup: {},mapOfTimestamps: {},mapOfBytes: {},mapOfStringValues: {},longLookup: {},boolLookup: new Map() };
    }
...
export const SimpleWithMap_BoolLookupEntry: MessageFns<SimpleWithMap_BoolLookupEntry> = {
              encode(
      message: SimpleWithMap_BoolLookupEntry,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
...
fromPartial<I extends Exact<DeepPartial<SimpleWithMap_BoolLookupEntry>, I>>(object: I): SimpleWithMap_BoolLookupEntry {
const message = createBaseSimpleWithMap_BoolLookupEntry();
