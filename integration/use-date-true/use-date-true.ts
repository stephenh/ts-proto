...
timestamp: isSet(object.timestamp)
          ...
          : undefined,
repeatedTimestamp: globalThis.Array.isArray(object?.repeatedTimestamp) ? object.repeatedTimestamp.map((e: any) => fromJsonTimestamp(e)): [],
...
export const ClockServiceName = "Clock";export class ClockClientImpl implements Clock {private readonly rpc: Rpc;private readonly service: string;constructor(rpc: Rpc, opts?: {service?: string}) {this.service = opts?.service || ClockServiceName;this.rpc = rpc;this.Now = this.Now.bind(this);}
    Now(
      request: Empty
    ): Promise<Timestamp> {
