...
function toTimestamp(instant: Temporal.Instant): Timestamp {
  ...
  const remainder = globalThis.Temporal.Instant.fromEpochMilliseconds(epochSeconds * 1e3).until(instant);
...
function fromTimestamp(t: Timestamp): Temporal.Instant {
  return globalThis.Temporal.Instant.fromEpochMilliseconds(t.seconds * 1e3).add(
