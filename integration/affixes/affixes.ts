...
switch (object) {
case PrefixAwesomeEnumSuffix.AWESOME_ENUM_AWESOME: return "AWESOME_ENUM_AWESOME";
case PrefixAwesomeEnumSuffix.AWESOME_ENUM_COOL: return "AWESOME_ENUM_COOL";
case PrefixAwesomeEnumSuffix.AWESOME_ENUM_JUST_OKAY: return "AWESOME_ENUM_JUST_OKAY";
...
export const PrefixAwesomeMessage_InnerSuffix: MessageFns<PrefixAwesomeMessage_InnerSuffix> = {
              encode(
      _: PrefixAwesomeMessage_InnerSuffix,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
return writer;
},
...
create<I extends Exact<DeepPartial<PrefixAwesomeMessage_InnerSuffix>, I>>(base?: I): PrefixAwesomeMessage_InnerSuffix {
        return PrefixAwesomeMessage_InnerSuffix.fromPartial(base ?? ({} as any));
      },
fromPartial<I extends Exact<DeepPartial<PrefixAwesomeMessage_InnerSuffix>, I>>(_: I): PrefixAwesomeMessage_InnerSuffix {
const message = createBasePrefixAwesomeMessage_InnerSuffix();
return message;
}
            };
...
export const AwesomeServiceServiceName = "affixes.AwesomeService";export class AwesomeServiceClientImpl implements AwesomeService {private readonly rpc: Rpc;private readonly service: string;constructor(rpc: Rpc, opts?: {service?: string}) {this.service = opts?.service || AwesomeServiceServiceName;this.rpc = rpc;}}
