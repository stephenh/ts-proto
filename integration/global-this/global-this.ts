...
fromJSON(object: any): Array {
      return {
values: gt.Array.isArray(object?.values) ? object.values.map((e: any) => String.fromJSON(e)): [],
};
},
