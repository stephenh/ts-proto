...
switch (object) {
case Enum.ENUM_UNRECOGNIZED: return "ENUM_UNRECOGNIZED";
case Enum.ENUM_ONE: return "ENUM_ONE";
case Enum.ENUM_TWO: return "ENUM_TWO";
...
export type ExtensionHolder<T extends string, V> = {
