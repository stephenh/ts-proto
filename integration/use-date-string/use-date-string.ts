...
timestamp: isSet(object.timestamp)
          ...
          : undefined,
repeatedTimestamp: globalThis.Array.isArray(object?.repeatedTimestamp) ? object.repeatedTimestamp.map((e: any) => globalThis.String(e)): [],
...
message.mapOfTimestamps =  Object.entries(object.mapOfTimestamps ?? {}).reduce<{ [key: string ]: string }>((acc, [key, value]) => {
              if (value !== undefined) {
                acc[key] = value;
              }
              return acc;
