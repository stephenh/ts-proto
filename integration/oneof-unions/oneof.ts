...
export function pleaseChoose_StateEnumFromJSON(
  object: any,
): PleaseChoose_StateEnum {
  switch (object) {
    case 0:
    case "UNKNOWN":
...
export function pleaseChoose_StateEnumToJSON(
  object: PleaseChoose_StateEnum,
): string {
  switch (object) {
...
export const PleaseChoose = {
  encode(
    ...
    if (message.choice?.$case === "aMessage") {
      PleaseChoose_Submessage.encode(
        message.choice.aMessage,
    ...
    if (message.value !== undefined) {
      Value.encode(Value.wrap(message.value), writer.uint32(106).fork())
        .ldelim();
    }
    return writer;
  },
  ...
  toJSON(message: PleaseChoose): unknown {
    ...
    message.choice?.$case === "aNumber" &&
      (obj.aNumber = message.choice?.aNumber);
    message.choice?.$case === "aString" &&
  ...
  fromPartial<I extends Exact<DeepPartial<PleaseChoose>, I>>(
    ...
    if (
      object.choice?.$case === "aNumber" &&
      object.choice?.aNumber !== undefined &&
      object.choice?.aNumber !== null
    ) {
      message.choice = { $case: "aNumber", aNumber: object.choice.aNumber };
    }
    if (
      object.choice?.$case === "aString" &&
      object.choice?.aString !== undefined &&
      object.choice?.aString !== null
    ) {
    ...
    if (
      ...
      message.choice = {
        $case: "aMessage",
        aMessage: PleaseChoose_Submessage.fromPartial(object.choice.aMessage),
      };
    }
    if (
      object.choice?.$case === "aBool" &&
      object.choice?.aBool !== undefined &&
      object.choice?.aBool !== null
    ) {
    ...
    if (
      ...
      message.choice = {
        $case: "bunchaBytes",
        bunchaBytes: object.choice.bunchaBytes,
      };
    }
    if (
      object.choice?.$case === "anEnum" &&
      object.choice?.anEnum !== undefined &&
      object.choice?.anEnum !== null
    ) {
    ...
    if (
      object.eitherOr?.$case === "or" &&
      object.eitherOr?.or !== undefined &&
      object.eitherOr?.or !== null
    ) {
    ...
    if (
      ...
      message.eitherOr = {
        $case: "thirdOption",
        thirdOption: object.eitherOr.thirdOption,
      };
    }
