...
export const TestService = {
  ...
  unaryBytesValue: {
    ...
    requestSerialize: (value: Uint8Array | undefined) =>
      Buffer.from(
        BytesValue.encode({ value: value ?? new Uint8Array() }).finish(),
      ),
  ...
  unaryBoolValue: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: boolean | undefined) =>
  ...
  value: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: any | undefined) =>
      Buffer.from(Value.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Value.decode(value),
    responseSerialize: (value: any | undefined) =>
      Buffer.from(Value.encode(value).finish()),
  ...
  listValue: {
    ...
    requestDeserialize: (value: Buffer) =>
      ListValue.unwrap(ListValue.decode(value)),
  ...
  serverStreaming: {
    ...
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: TestMessage) =>
      Buffer.from(TestMessage.encode(value).finish()),
    requestDeserialize: (value: Buffer) => TestMessage.decode(value),
    responseSerialize: (value: TestMessage) =>
      Buffer.from(TestMessage.encode(value).finish()),
...
export interface TestServer extends UntypedServiceImplementation {
  ...
  unaryBytesValue: handleUnaryCall<
  ...
  serverStreamingStringValue: handleServerStreamingCall<
    string | undefined,
    string | undefined
  >;
  ...
  clientStreamingStringValue: handleClientStreamingCall<
    string | undefined,
    string | undefined
  >;
  /** Bidi Streaming */
  bidiStreaming: handleBidiStreamingCall<TestMessage, TestMessage>;
  bidiStreamingStringValue: handleBidiStreamingCall<
    string | undefined,
    string | undefined
  >;
}
...
export interface TestClient extends Client {
  ...
  bidiStreaming(
    options: Partial<CallOptions>,
  ): ClientDuplexStream<TestMessage, TestMessage>;
  bidiStreaming(
    metadata: Metadata,
    options?: Partial<CallOptions>,
  ): ClientDuplexStream<TestMessage, TestMessage>;
  bidiStreamingStringValue(): ClientDuplexStream<
    string | undefined,
    string | undefined
  >;
  bidiStreamingStringValue(
