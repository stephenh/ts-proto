...
import type { ClientOptions, UntypedServiceImplementation, handleUnaryCall, handleServerStreamingCall, handleClientStreamingCall, handleBidiStreamingCall, ClientUnaryCall, CallOptions, ClientReadableStream, ClientWritableStream, ClientDuplexStream, ServiceError } from '@grpc/grpc-js';
import { BinaryWriter, BinaryReader } from '@bufbuild/protobuf/wire';
import { Empty } from './google/protobuf/empty';
import { StringValue, Int64Value, UInt64Value, Int32Value, UInt32Value, BytesValue, FloatValue, DoubleValue, BoolValue } from './google/protobuf/wrappers';
...
value: {
        ...
        requestSerialize: (value: any | undefined) =>
          Buffer.from(Value.encode(Value.wrap(value)).finish()),
...
serverStreamingStruct: handleServerStreamingCall<{[key: string]: any} | undefined, {[key: string]: any} | undefined>;
/** Client Streaming */
