...
// source: grpc-js-use-date-temporal-bigint.proto
...
type Builtin = Date | Function | Uint8Array | string | number | boolean | bigint | Temporal.Instant | undefined;
...
function fromTimestamp(t: Timestamp): Temporal.Instant {
  const seconds = globalThis.Number(t.seconds.toString()) || 0;
