...
switch (object) {
case GRPCPNullValueGRPCS.NULL_VALUE: return "NULL_VALUE";
...
nullValue?: GRPCPNullValueGRPCS | undefined,
...
export const GRPCPStruct_FieldsEntryGRPCS: MessageFns<GRPCPStruct_FieldsEntryGRPCS> = {
              encode(
      message: GRPCPStruct_FieldsEntryGRPCS,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
if ( message.key !== "") {
...
function createBaseGRPCPValueGRPCS(): GRPCPValueGRPCS {
      return { nullValue: undefined,numberValue: undefined,stringValue: undefined,boolValue: undefined,structValue: undefined,listValue: undefined };
    }

export const GRPCPValueGRPCS: MessageFns<GRPCPValueGRPCS> & AnyValueWrapperFns = {
              encode(
      message: GRPCPValueGRPCS,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
