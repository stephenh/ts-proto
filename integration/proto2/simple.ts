...
function createBaseOptionalsTest(): OptionalsTest {
      return { repId: [],repChild: [],repState: [],repLong: [],repTruth: [],repDescription: [],repData: [],repFloat: [],optId: 0,optChild: undefined,optState: 0,optLong: 0,optTruth: false,optDescription: "",optData: new Uint8Array(0),optFloat: 0,reqId: 0,reqChild: undefined,reqState: 0,reqLong: 0,reqTruth: false,reqDescription: "",reqData: new Uint8Array(0),reqFloat: 0,reqDefvalId: 100,reqDefvalState: 2,reqDefvalLong: 7812378193,reqDefvalTruth: true,reqDefvalDescription: "Some description",reqDefvalData: new Uint8Array(0),reqDefvalFloat: 0.12354,optDefvalId: 100,optDefvalState: 2,optDefvalLong: 7812378193,optDefvalTruth: true,optDefvalDescription: "Some description",optDefvalData: new Uint8Array(0),optDefvalFloat: 0.12354,translations: {} };
    }
