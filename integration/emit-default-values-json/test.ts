...
export const DefaultValuesTest_TranslationsEntry: MessageFns<DefaultValuesTest_TranslationsEntry> = {
              encode(
      message: DefaultValuesTest_TranslationsEntry,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
if ( message.key !== "") {
...
create<I extends Exact<DeepPartial<DefaultValuesTest_TranslationsEntry>, I>>(base?: I): DefaultValuesTest_TranslationsEntry {
        return DefaultValuesTest_TranslationsEntry.fromPartial(base ?? ({} as any));
      },
fromPartial<I extends Exact<DeepPartial<DefaultValuesTest_TranslationsEntry>, I>>(object: I): DefaultValuesTest_TranslationsEntry {
const message = createBaseDefaultValuesTest_TranslationsEntry();
