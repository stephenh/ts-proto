...
export const Simple = {
  ...
  fromJSON(object: any): Simple {
    return {
      ...
      snacks: Array.isArray(object?.snacks)
        ...
        : [],
      old_states: Array.isArray(object?.old_states)
  ...
  toJSON(message: Simple): unknown {
    ...
    if (message.grand_children) {
      obj.grand_children = message.grand_children.map((e) =>
  ...
  fromPartial<I extends Exact<DeepPartial<Simple>, I>>(object: I): Simple {
    ...
    message.grand_children =
      object.grand_children?.map((e) => Child.fromPartial(e)) || [];
...
export const SimpleWithSnakeCaseMap = {
  ...
  fromJSON(object: any): SimpleWithSnakeCaseMap {
    return {
      entities_by_id: isObject(object.entities_by_id)
        ? Object.entries(object.entities_by_id).reduce<
          { [key: number]: Entity }
        >((acc, [key, value]) => {
          acc[Number(key)] = Entity.fromJSON(value);
          return acc;
  ...
  fromPartial<I extends Exact<DeepPartial<SimpleWithSnakeCaseMap>, I>>(
    ...
    const message = createBaseSimpleWithSnakeCaseMap();
    message.entities_by_id = Object.entries(object.entities_by_id ?? {}).reduce<
      { [key: number]: Entity }
    >((acc, [key, value]) => {
      if (value !== undefined) {
        acc[Number(key)] = Entity.fromPartial(value);
...
export const SimpleStruct = {
  encode(
    ...
    if (message.simple_struct !== undefined) {
      Struct.encode(
        Struct.wrap(message.simple_struct),
        writer.uint32(10).fork(),
      ).ldelim();
    }
    return writer;
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.simple_struct = Struct.unwrap(
  ...
  fromJSON(object: any): SimpleStruct {
    return {
      simple_struct: isObject(object.simple_struct)
