...
function createBaseSimple(): Simple {
      return { name: "",age: 0,created_at: undefined,child: undefined,state: 0,grand_children: [],coins: [],snacks: [],old_states: [],thing: undefined };
    }
...
state: isSet(object.state)
          ...
          : 0,
grand_children: globalThis.Array.isArray(object?.grand_children) ? object.grand_children.map((e: any) => Child.fromJSON(e)): [],
...
old_states: globalThis.Array.isArray(object?.old_states) ? object.old_states.map((e: any) => stateEnumFromJSON(e)): [],
...
const message = createBaseSimpleWithSnakeCaseMap();
message.entities_by_id =  Object.entries(object.entities_by_id ?? {}).reduce<{ [key: number ]: Entity }>((acc, [key, value]) => {
              if (value !== undefined) {
                acc[globalThis.Number(key)] = Entity.fromPartial(value);
              }
              return acc;
