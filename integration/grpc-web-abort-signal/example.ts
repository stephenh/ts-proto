...
switch (object) {
case DashFlash_Type.Undefined: return "Undefined";
case DashFlash_Type.Success: return "Success";
case DashFlash_Type.Warn: return "Warn";
case DashFlash_Type.Error: return "Error";
...
msg: isSet(object.msg)
          ? globalThis.String(object.msg)
          : "",
type: isSet(object.type)
          ? dashFlash_TypeFromJSON(object.type)
          : 0,
};
},
...
UserSettings(request: DeepPartial<Empty>,metadata?: grpc.Metadata,abortSignal?: AbortSignal): Promise<DashUserSettingsState>;
ActiveUserSettingsStream(request: DeepPartial<Empty>,metadata?: grpc.Metadata,abortSignal?: AbortSignal): Observable<DashUserSettingsState>;
/** not supported in grpc-web, but should still compile */
ChangeUserSettingsStream(request: Observable<DeepPartial<DashUserSettingsState>>,metadata?: grpc.Metadata,abortSignal?: AbortSignal): Observable<DashUserSettingsState>;
}
...
Create(request: DeepPartial<DashAPICredsCreateReq>,metadata?: grpc.Metadata,abortSignal?: AbortSignal): Promise<DashCred>;
Update(request: DeepPartial<DashAPICredsUpdateReq>,metadata?: grpc.Metadata,abortSignal?: AbortSignal): Promise<DashCred>;
Delete(request: DeepPartial<DashAPICredsDeleteReq>,metadata?: grpc.Metadata,abortSignal?: AbortSignal): Promise<DashCred>;
}
