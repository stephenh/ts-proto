...
export interface Simple {
  ...
  luckyNumbers: number[];
  properties: { [key: string | undefined]: string };
}
...
export const Simple = {
  ...
  fromJSON(object: any): Simple {
    return {
      ...
      properties: isObject(object.properties)
        ? Object.entries(object.properties).reduce<{ [key: string | undefined]: string }>((acc, [key, value]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<Simple>, I>>(object: I): Simple {
    ...
    message.properties = Object.entries(object.properties ?? {}).reduce<{ [key: string | undefined]: string }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
