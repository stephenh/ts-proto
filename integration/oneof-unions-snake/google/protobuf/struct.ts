...
if (tag !== 50) {
        ...
        message.kind = { $case: 'list_value', list_value: ListValue.unwrap(ListValue.decode(reader, reader.uint32())) };
continue; }
}
if ((tag & 7) === 4 || tag === 0) {
        break;
...
fromJSON(object: any): Value {
      return {
kind:
isSet(object.null_value) ? { $case: 'null_value', null_value: nullValueFromJSON(object.null_value)} :
isSet(object.number_value) ? { $case: 'number_value', number_value: globalThis.Number(object.number_value)} :
isSet(object.string_value) ? { $case: 'string_value', string_value: globalThis.String(object.string_value)} :
isSet(object.bool_value) ? { $case: 'bool_value', bool_value: globalThis.Boolean(object.bool_value)} :
isSet(object.struct_value) ? { $case: 'struct_value', struct_value: object.struct_value} :
isSet(object.list_value) ? { $case: 'list_value', list_value: [...object.list_value]} :
undefined,
};
},
...
case 'null_value': {
          if (object.kind?.null_value !== undefined
...
case 'number_value': {
          if (object.kind?.number_value !== undefined
...
case 'string_value': {
          if (object.kind?.string_value !== undefined
...
case 'bool_value': {
          if (object.kind?.bool_value !== undefined
...
case 'struct_value': {
          if (object.kind?.struct_value !== undefined
...
case 'list_value': {
          if (object.kind?.list_value !== undefined
