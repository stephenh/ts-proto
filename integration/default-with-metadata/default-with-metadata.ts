...
export const BasicServiceServiceName = "basic.BasicService";export class BasicServiceClientImpl implements BasicService {private readonly rpc: Rpc;private readonly service: string;constructor(rpc: Rpc, opts?: {service?: string}) {this.service = opts?.service || BasicServiceServiceName;this.rpc = rpc;this.GetBasic = this.GetBasic.bind(this);}
    GetBasic(
      request: GetBasicRequest,metadata?: Metadata
