...
ChangeUserSettingsStream(request: Observable<DeepPartial<DashUserSettingsState>>,metadata?: grpc.Metadata): Observable<DashUserSettingsState>;
}
...
this.Uppercase = this.Uppercase.bind(this);
    ...
    Uppercase(
      ...
      return this.rpc.unary(
        DashAPICredsUppercaseDesc,
        StringValue.fromPartial(request),
        metadata,
