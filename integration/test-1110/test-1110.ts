...
export const APIServiceServiceName = "APIService";export class APIServiceClientImpl implements APIService {private readonly rpc: Rpc;private readonly service: string;constructor(rpc: Rpc, opts?: {service?: string}) {this.service = opts?.service || APIServiceServiceName;this.rpc = rpc;}}
