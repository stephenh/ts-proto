...
export function nullValueFromJSON(object: any): NullValue | undefined {
  switch (object) {
    case 0:
    case undefined:
      return undefined;
...
export function nullValueToJSON(object: NullValue | undefined): string | undefined {
  switch (object) {
    case undefined:
      return undefined;
...
export function nullValueToNumber(object: NullValue | undefined): number {
  switch (object) {
    case undefined:
      return 0;
    case NullValue.UNRECOGNIZED:
...
export interface Value {
  ...
  nullValue: (NullValue | undefined) | undefined;
