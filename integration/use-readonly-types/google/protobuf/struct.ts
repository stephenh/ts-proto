...
fromJSON(object: any): Value {
      return {
kind:
isSet(object.nullValue) ? { $case: 'nullValue', nullValue: nullValueFromJSON(object.nullValue)} :
isSet(object.numberValue) ? { $case: 'numberValue', numberValue: globalThis.Number(object.numberValue)} :
isSet(object.stringValue) ? { $case: 'stringValue', stringValue: globalThis.String(object.stringValue)} :
isSet(object.boolValue) ? { $case: 'boolValue', boolValue: globalThis.Boolean(object.boolValue)} :
isSet(object.structValue) ? { $case: 'structValue', structValue: object.structValue} :
isSet(object.listValue) ? { $case: 'listValue', listValue: [...object.listValue]} :
undefined,
};
},
...
case 'nullValue': {
          if (object.kind?.nullValue !== undefined
...
case 'numberValue': {
          if (object.kind?.numberValue !== undefined
...
case 'stringValue': {
          if (object.kind?.stringValue !== undefined
...
case 'boolValue': {
          if (object.kind?.boolValue !== undefined
...
case 'structValue': {
          if (object.kind?.structValue !== undefined
...
case 'listValue': {
          if (object.kind?.listValue !== undefined
