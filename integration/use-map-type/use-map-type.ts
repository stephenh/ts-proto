...
function createBaseMaps(): Maps {
      return { strToEntity: new Map(),int32ToInt32: new Map(),stringToBytes: new Map(),int64ToInt64: new Map(),mapOfTimestamps: new Map(),struct: undefined };
    }
...
export const Maps_StringToBytesEntry: MessageFns<Maps_StringToBytesEntry> = {
              encode(
      message: Maps_StringToBytesEntry,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
if ( message.key !== "") {
          writer.uint32(10).string(message.key);
...
export const Maps_Int64ToInt64Entry: MessageFns<Maps_Int64ToInt64Entry> = {
              encode(
      message: Maps_Int64ToInt64Entry,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
if ( message.key !== 0) {
...
export const Maps_MapOfTimestampsEntry: MessageFns<Maps_MapOfTimestampsEntry> = {
              encode(
      message: Maps_MapOfTimestampsEntry,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
if ( message.key !== "") {
          writer.uint32(10).string(message.key);
