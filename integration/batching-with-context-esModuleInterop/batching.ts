...
create<I extends Exact<DeepPartial<BatchMapQueryResponse_EntitiesEntry>, I>>(base?: I): BatchMapQueryResponse_EntitiesEntry {
        return BatchMapQueryResponse_EntitiesEntry.fromPartial(base ?? ({} as any));
      },
fromPartial<I extends Exact<DeepPartial<BatchMapQueryResponse_EntitiesEntry>, I>>(object: I): BatchMapQueryResponse_EntitiesEntry {
const message = createBaseBatchMapQueryResponse_EntitiesEntry();
...
export const EntityServiceServiceName = "batching.EntityService";export class EntityServiceClientImpl<Context extends DataLoaders> implements EntityService<Context> {private readonly rpc: Rpc<Context>;private readonly service: string;constructor(rpc: Rpc<Context>, opts?: {service?: string}) {this.service = opts?.service || EntityServiceServiceName;this.rpc = rpc;this.BatchQuery = this.BatchQuery.bind(this);this.BatchMapQuery = this.BatchMapQuery.bind(this);this.GetOnlyMethod = this.GetOnlyMethod.bind(this);this.WriteMethod = this.WriteMethod.bind(this);}
    GetQuery(
      ctx: Context,
      id: string
    ): Promise<Entity> {
      const dl = ctx.getDataLoader("batching.EntityService.BatchQuery", () => {
        return new DataLoader<string, Entity, string>(
          (ids) => {
      const request = { ids };return this.BatchQuery(ctx, request as any).then(res => res.entities)},
    ...
    BatchQuery(
      ctx: Context,request: BatchQueryRequest
    ...
    GetMapQuery(
      ...
      const dl = ctx.getDataLoader("batching.EntityService.BatchMapQuery", () => {
        return new DataLoader<string, Entity, string>(
          (ids) => {
      const request = { ids };return this.BatchMapQuery(ctx, request as any).then(res => {
    ...
    BatchMapQuery(
      ctx: Context,request: BatchMapQueryRequest
    ...
    GetOnlyMethod(
      ...
      const dl = ctx.getDataLoader("batching.EntityService.GetOnlyMethod", () => {
        return new DataLoader<GetOnlyMethodRequest, GetOnlyMethodResponse, string>(
  ...
  ,
    ...
    WriteMethod(
      ctx: Context,request: WriteMethodRequest
