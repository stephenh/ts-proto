...
export const metaTimestamp: { [key in keyof Required<Timestamp>]: MetaI | string } = {
  seconds: {meta:'builtin', type:'number', original:'int64'} as MetaB,
  nanos: {meta:'builtin', type:'number', original:'int32'} as MetaB,
}
