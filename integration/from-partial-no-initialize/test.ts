...
field: isSet(object.field)
          ? globalThis.String(object.field)
          : undefined,
};
},
...
message: isSet(object.message)
          ? TPartialMessage.fromJSON(object.message)
          : undefined,
repeatedMessage: globalThis.Array.isArray(object?.repeatedMessage) ? object.repeatedMessage.map((e: any) => TPartialMessage.fromJSON(e)): undefined,
repeatedString: globalThis.Array.isArray(object?.repeatedString) ? object.repeatedString.map((e: any) => globalThis.String(e)): undefined,
repeatedNumber: globalThis.Array.isArray(object?.repeatedNumber) ? object.repeatedNumber.map((e: any) => globalThis.Number(e)): undefined,
};
},
...
message.map = (object.map === undefined || object.map === null) ? undefined :  Object.entries(object.map ?? {}).reduce<{ [key: string ]: string }>((acc, [key, value]) => {
              if (value !== undefined) {
