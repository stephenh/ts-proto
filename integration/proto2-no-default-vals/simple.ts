...
function createBaseOptionalsTest(): OptionalsTest {
      return { repId: [],repChild: [],repState: [],repLong: [],repTruth: [],repDescription: [],repData: [],repFloat: [],optId: 0,optChild: undefined,optState: 0,optLong: 0,optTruth: false,optDescription: "",optData: new Uint8Array(0),optFloat: 0,reqId: 0,reqChild: undefined,reqState: 0,reqLong: 0,reqTruth: false,reqDescription: "",reqData: new Uint8Array(0),reqFloat: 0,reqDefvalId: 0,reqDefvalState: 0,reqDefvalLong: 0,reqDefvalTruth: false,reqDefvalDescription: "",reqDefvalData: new Uint8Array(0),reqDefvalFloat: 0,optDefvalId: 0,optDefvalState: 0,optDefvalLong: 0,optDefvalTruth: false,optDefvalDescription: "",optDefvalData: new Uint8Array(0),optDefvalFloat: 0,translations: {} };
    }
...
repTruth: globalThis.Array.isArray(object?.repTruth) ? object.repTruth.map((e: any) => globalThis.Boolean(e)): [],
repDescription: globalThis.Array.isArray(object?.repDescription) ? object.repDescription.map((e: any) => globalThis.String(e)): [],
...
message.translations =  Object.entries(object.translations ?? {}).reduce<{ [key: string ]: string }>((acc, [key, value]) => {
              if (value !== undefined) {
...
fromPartial<I extends Exact<DeepPartial<OptionalsTest_TranslationsEntry>, I>>(object: I): OptionalsTest_TranslationsEntry {
const message = createBaseOptionalsTest_TranslationsEntry();
