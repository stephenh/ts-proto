...
switch (object) {
case Foo.UNSPECIFIED: return "FOO_UNSPECIFIED";
case Foo.BAR: return "FOO_BAR";
case Foo.BAZ: return "FOO_BAZ";
default:
        throw new globalThis.Error("Unrecognized enum value " + object + " for enum Foo");
}
}
...
case Foo.BAR: return 1;
case Foo.BAZ: return 2;
default:
        throw new globalThis.Error("Unrecognized enum value " + object + " for enum Foo");
}
}
...
switch (object) {
case Bar.UNSPECIFIED: return "BAR_UNSPECIFIED";
case Bar.BAZ: return "BAZ";
case Bar.QUX: return "QUX";
default:
        throw new globalThis.Error("Unrecognized enum value " + object + " for enum Bar");
}
}
...
case Bar.BAZ: return 1;
case Bar.QUX: return 2;
default:
        throw new globalThis.Error("Unrecognized enum value " + object + " for enum Bar");
}
}
...
switch (object) {
case WithNestedEnum_Baz.UNSPECIFIED: return "BAZ_UNSPECIFIED";
case WithNestedEnum_Baz.ONE: return "BAZ_ONE";
case WithNestedEnum_Baz.TWO: return "BAZ_TWO";
default:
        throw new globalThis.Error("Unrecognized enum value " + object + " for enum WithNestedEnum_Baz");
}
}
...
case WithNestedEnum_Baz.ONE: return 1;
case WithNestedEnum_Baz.TWO: return 2;
default:
        throw new globalThis.Error("Unrecognized enum value " + object + " for enum WithNestedEnum_Baz");
}
}
...
switch (object) {
case WithNestedEnum_Qux.UNSPECIFIED: return "QUX_UNSPECIFIED";
case WithNestedEnum_Qux.ONE: return "ONE";
case WithNestedEnum_Qux.TWO: return "TWO";
default:
        throw new globalThis.Error("Unrecognized enum value " + object + " for enum WithNestedEnum_Qux");
}
}
...
case WithNestedEnum_Qux.ONE: return 1;
case WithNestedEnum_Qux.TWO: return 2;
default:
        throw new globalThis.Error("Unrecognized enum value " + object + " for enum WithNestedEnum_Qux");
}
}
...
function createBaseWithNestedEnum(): WithNestedEnum {
      return { foo: Foo.UNSPECIFIED,Bar: Bar.UNSPECIFIED,baz: WithNestedEnum_Baz.UNSPECIFIED,qux: WithNestedEnum_Qux.UNSPECIFIED };
    }
...
fromJSON(object: any): WithNestedEnum {
      return {
foo: isSet(object.foo)
          ? fooFromJSON(object.foo)
          : Foo.UNSPECIFIED,
Bar: isSet(object.Bar)
          ? barFromJSON(object.Bar)
          : Bar.UNSPECIFIED,
baz: isSet(object.baz)
          ? withNestedEnum_BazFromJSON(object.baz)
          : WithNestedEnum_Baz.UNSPECIFIED,
qux: isSet(object.qux)
          ? withNestedEnum_QuxFromJSON(object.qux)
          : WithNestedEnum_Qux.UNSPECIFIED,
};
},
