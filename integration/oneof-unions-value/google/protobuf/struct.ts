...
fromJSON(object: any): Value {
      return {
kind:
isSet(object.nullValue) ? { $case: 'nullValue', value: nullValueFromJSON(object.nullValue)} :
isSet(object.numberValue) ? { $case: 'numberValue', value: globalThis.Number(object.numberValue)} :
isSet(object.stringValue) ? { $case: 'stringValue', value: globalThis.String(object.stringValue)} :
isSet(object.boolValue) ? { $case: 'boolValue', value: globalThis.Boolean(object.boolValue)} :
isSet(object.structValue) ? { $case: 'structValue', value: object.structValue} :
isSet(object.listValue) ? { $case: 'listValue', value: [...object.listValue]} :
undefined,
};
},
...
case 'nullValue': {
          if (object.kind?.value !== undefined
