...
name: isSet(object.name)
          ...
          : "",
choice:
isSet(object.aNumber) ? { $case: 'aNumber', value: globalThis.Number(object.aNumber)} :
isSet(object.aString) ? { $case: 'aString', value: globalThis.String(object.aString)} :
isSet(object.aMessage) ? { $case: 'aMessage', value: PleaseChoose_Submessage.fromJSON(object.aMessage)} :
isSet(object.aBool) ? { $case: 'aBool', value: globalThis.Boolean(object.aBool)} :
isSet(object.bunchaBytes) ? { $case: 'bunchaBytes', value: bytesFromBase64(object.bunchaBytes)} :
isSet(object.anEnum) ? { $case: 'anEnum', value: pleaseChoose_StateEnumFromJSON(object.anEnum)} :
undefined,
age: isSet(object.age)
          ? globalThis.Number(object.age)
          : 0,
eitherOr:
isSet(object.either) ? { $case: 'either', value: globalThis.String(object.either)} :
isSet(object.or) ? { $case: 'or', value: globalThis.String(object.or)} :
isSet(object.thirdOption) ? { $case: 'thirdOption', value: globalThis.String(object.thirdOption)} :
undefined,
...
case 'aNumber': {
          if (object.choice?.value !== undefined
...
case 'either': {
          if (object.eitherOr?.value !== undefined
