...
fromJSON(object: any): NumPair {
      return {
num1: isSet(object.num1)
          ? globalThis.Number(object.num1)
          : 0,
num2: isSet(object.num2)
...
fromJSON(object: any): NumSingle {
      return {
num: isSet(object.num)
          ? globalThis.Number(object.num)
          : 0,
};
},
...
fromJSON(object: any): Numbers {
      return {
num: globalThis.Array.isArray(object?.num) ? object.num.map((e: any) => globalThis.Number(e)): [],
};
},
...
export const MathServiceServiceName = "MathService";export class MathServiceClientImpl<Context extends DataLoaders> implements MathService<Context> {private readonly rpc: Rpc<Context>;private readonly service: string;constructor(rpc: Rpc<Context>, opts?: {service?: string}) {this.service = opts?.service || MathServiceServiceName;this.rpc = rpc;this.add = this.add.bind(this);this.absoluteValue = this.absoluteValue.bind(this);this.batchDouble = this.batchDouble.bind(this);}
    add(
      ctx: Context,request: NumPair
    ): Promise<NumSingle> {
    ...
    getDouble(
      ...
      const dl = ctx.getDataLoader("MathService.BatchDouble", () => {
        return new DataLoader<number, number, string>(
          (num) => {
      const request = { num };return this.batchDouble(ctx, request as any).then(res => res.num)},
