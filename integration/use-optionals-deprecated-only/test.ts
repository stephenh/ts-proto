...
function createBaseOptionalsTest(): OptionalsTest {
      return { id: 0,state: 0,long: 0,truth: false,description: "",data: new Uint8Array(0),repId: [],repState: [],repStateV2: [],repLong: [],repTruth: [],repDescription: [],repData: [],optId: undefined,optState: undefined,optLong: undefined,optTruth: undefined,optDescription: undefined,optData: undefined,translations: {} };
    }
...
repStateV2: globalThis.Array.isArray(object?.repStateV2) ? object.repStateV2.map((e: any) => stateEnumFromJSON(e)): [],
