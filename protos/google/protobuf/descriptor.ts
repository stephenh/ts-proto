...
export const FileDescriptorSet: MessageFns<FileDescriptorSet> & ExtensionFns<FileDescriptorSet> = {
  ...
  setExtension<T>(message: FileDescriptorSet, extension: Extension<T>, value: T): void {
  ...
  getExtension<T>(message: FileDescriptorSet, extension: Extension<T>): T | undefined {
...
export const ExtensionRangeOptions: MessageFns<ExtensionRangeOptions> & ExtensionFns<ExtensionRangeOptions> = {
...
export const ExtensionRangeOptions_Declaration: MessageFns<ExtensionRangeOptions_Declaration> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExtensionRangeOptions_Declaration {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = Object.create(createBaseExtensionRangeOptions_Declaration()) as ExtensionRangeOptions_Declaration;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
...
export const FileOptions: MessageFns<FileOptions> & ExtensionFns<FileOptions> = {
...
export const MessageOptions: MessageFns<MessageOptions> & ExtensionFns<MessageOptions> = {
...
export const FieldOptions: MessageFns<FieldOptions> & ExtensionFns<FieldOptions> = {
...
export const FieldOptions_EditionDefault: MessageFns<FieldOptions_EditionDefault> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FieldOptions_EditionDefault {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = Object.create(createBaseFieldOptions_EditionDefault()) as FieldOptions_EditionDefault;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 3: {
...
export const FieldOptions_FeatureSupport: MessageFns<FieldOptions_FeatureSupport> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FieldOptions_FeatureSupport {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = Object.create(createBaseFieldOptions_FeatureSupport()) as FieldOptions_FeatureSupport;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
...
export const OneofOptions: MessageFns<OneofOptions> & ExtensionFns<OneofOptions> = {
...
export const EnumOptions: MessageFns<EnumOptions> & ExtensionFns<EnumOptions> = {
...
export const EnumValueOptions: MessageFns<EnumValueOptions> & ExtensionFns<EnumValueOptions> = {
...
export const ServiceOptions: MessageFns<ServiceOptions> & ExtensionFns<ServiceOptions> = {
...
export const MethodOptions: MessageFns<MethodOptions> & ExtensionFns<MethodOptions> = {
...
export const FeatureSet: MessageFns<FeatureSet> & ExtensionFns<FeatureSet> = {
  ...
  setExtension<T>(message: FeatureSet, extension: Extension<T>, value: T): void {
    const encoded = extension.encode!(value);
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FeatureSet {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = Object.create(createBaseFeatureSet()) as FeatureSet;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  getExtension<T>(message: FeatureSet, extension: Extension<T>): T | undefined {
    let results: T | undefined = undefined;
...
export const FeatureSet_VisibilityFeature: MessageFns<FeatureSet_VisibilityFeature> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FeatureSet_VisibilityFeature {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = Object.create(createBaseFeatureSet_VisibilityFeature()) as FeatureSet_VisibilityFeature;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
...
export const FeatureSetDefaults: MessageFns<FeatureSetDefaults> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FeatureSetDefaults {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = Object.create(createBaseFeatureSetDefaults()) as FeatureSetDefaults;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
...
export const FeatureSetDefaults_FeatureSetEditionDefault: MessageFns<FeatureSetDefaults_FeatureSetEditionDefault> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FeatureSetDefaults_FeatureSetEditionDefault {
    ...
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = Object.create(
      createBaseFeatureSetDefaults_FeatureSetEditionDefault(),
...
export const SourceCodeInfo: MessageFns<SourceCodeInfo> & ExtensionFns<SourceCodeInfo> = {
  ...
  setExtension<T>(message: SourceCodeInfo, extension: Extension<T>, value: T): void {
    const encoded = extension.encode!(value);
  ...
  getExtension<T>(message: SourceCodeInfo, extension: Extension<T>): T | undefined {
    let results: T | undefined = undefined;
